...
export default function EditProject() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-950 dark:via-black dark:to-indigo-950 flex items-center justify-center">
                <div className="text-center">
                    <Loader className="inline-block animate-spin h-16 w-16 text-indigo-500" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        <div className="flex gap-6 pt-8">
                            ...
                            >
                                ...
                                {!saving && <Save size={20} className="group-hover:scale-110 transition-transform" />}
                            </button>
